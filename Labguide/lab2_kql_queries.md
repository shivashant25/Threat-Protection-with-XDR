...
1. Select **Upgrade** next to the workspace you created earlier.  This might take a 2-5 minutes, wait until you see the notification *"Defender plans for workspace were saved successfully"*.
